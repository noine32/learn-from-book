...
import { verifyRustTechnique } from './adapters/rust.ts';

// 使い方: npx tsx src/cli.ts <technique-dir>
// ランタイムは中身で自動判定: impl.bas=excel-vba(Windows) / impl.py=python / impl.go=go / Cargo.toml=rust / それ以外=node。
